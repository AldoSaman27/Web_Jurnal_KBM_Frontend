...
const BuatJurnal = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`${process.env.REACT_APP_API_URL}/api/jurnal/store`, formData).then(() => {
            setIsLoading(false);
            ...
            if (err.response.status === 422) {
                return Swal.fire({
                    ...
                    text: err.response.data.errors.nip || err.response.data.errors.hari_tanggal || err.response.data.errors.jam_ke || err.response.data.errors.kelas || err.response.data.errors.uraian_kegiatan || err.response.data.errors.kehadiran || err.response.data.errors.foto_kegiatan,
                    icon: "error",
                    showCancelButton: false,
                    confirmButtonText: "Oke",
                });
